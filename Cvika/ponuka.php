...
if (!$mysqli->connect_errno) {
	$sql = "SELECT * FROM kvety_tovar WHERE na_sklade>0 "; // definuj dopyt
	if (isset($_POST['zoradit']) && ($_POST['zoradit'] == 'nazov2')) $sql .= 'ORDER BY nazov DESC'; 
	elseif (isset($_POST['zoradit']) && ($_POST['zoradit'] == 'cena1')) $sql .= 'ORDER BY cena ASC'; 
	elseif (isset($_POST['zoradit']) && ($_POST['zoradit'] == 'cena2')) $sql .= 'ORDER BY cena DESC';
